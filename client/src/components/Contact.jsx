...
import backgroundImage from './bh.jpg'; // Import your background image
              ...
              <div className="p-6">
                ...
                <div className="info-item flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <span className="block">Bhatti Road, Chandarsar Basti, Bathinda</span>
                  </div>
                </div>
                <div className="info-item flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <span className="block">9878911298, 9041119390</span>
                  </div>
                </div>
                <div className="info-item flex items-center">
                  ...
                  <div>
                    ...
                    <span className="block">lavinaguglani456@gmail.com</span>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-4">Send us a message</h3>
                <form action="https://formsubmit.co/lavinaarora824@gmail.com" method="POST">
